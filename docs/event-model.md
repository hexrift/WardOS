...
| Mode | Shows | Blocks? |
| --- | --- | --- |
| Quiet | `AgentStateChanged`, `PolicyDenied`, `Capability*` needing approval, `Verification{Passed,Failed,Errored,Cancelled,Interrupted}`, `ObservationsDropped`, `SessionEnded` | Only on `Ask` |
