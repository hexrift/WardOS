...
SECURITY   Verify current project · Review permissions · Pause all sessions ·
           Replay last session · Evidence · Snapshots · Grant credential…
